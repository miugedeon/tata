...
<div id="c_outter">
	...
	<div id="c_content">
        ...
        <div class="c_channelpic" style="background:url(images/<?php echo $bgName ?>) no-repeat center center;height:425px;"></div>
		<div class='bannerbtbg'></div>
        <?php } ?>
...
<div id="ssss"></div>
<style type="text/css">
#pppp{position:absolute;top:30px;left:50%;width:1004px;margin-left:-507px;overflow:hidden;display:none;z-index:99999}
#ssss{position:absolute;top:0px;left:0px;width:100%;height:100%;background:#000;overflow:hidden;display:none;FILTER: alpha(opacity=80); opacity: 0.8; -moz-opacity: 0.8;z-index:99998}
</style>
</body>
</html>
