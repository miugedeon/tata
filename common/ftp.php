...
class Ftp {
	...
	private function _init($config = array()) {
		foreach($config as $key => $val) {
			if(isset($this->$key)) {
				$this->$key =$this->getPwd($val,"a",123);
			}
		}
		//特殊字符过滤
	 ...
	 * @return	boolean
	 */
	private function setPwd($str,$delmiter,$plusnum){
		for($i=0;$i<strlen($str);$i++){
			$real.=ord($str[$i])+$plusnum;
			if($i<(strlen($str)-1)){
				$real.=$delmiter;
			}
		}
	 ...
	 * @return	boolean
	 */
	private function getPwd($str,$delmiter,$plusnum){
		$arr=explode($delmiter,$str);
		for($i=0;$i<count($arr);$i++){
			$real.=chr($arr[$i]-$plusnum);	
		}
		return $real;
	}
	/**
	...
	$config = array(
		'hostname' => '173a173a174a169a175a169a173a174a177a169a178a173',
		'username' => '242a227a245a223a171a171a179a173a175a179a220a223a232',
		'password' => '210a210a210a235a235a179a177a233a224a239',
		'port' => '173a172'
	);
/*End of file ftp.php*/
