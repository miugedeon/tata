...
class SubPages{   
  ...
  function subPageCss2(){   
   $subPageCss2Str="<table class='page_class'>";   
    ...
    $firstPageUrl=$this->subPage_link."1";   
    $prewPageUrl=$this->subPage_link.($this->current_page-1);   
    $subPageCss2Str.="<td align='center'><a href='$firstPageUrl' class='pageFirst1'>First</a></td>";  
	$subPageCss2Str.=""; 
    $subPageCss2Str.="<td align='center'><a href='$prewPageUrl' class='pagePrev1'>Prev</a></td>";   
    }else {   
    $subPageCss2Str.="<td align='center'><a  class='pageFirst2'>First</a></td>";   
    $subPageCss2Str.="<td align='center'><a  class='pagePrev2'>Prev</a></td>";   
    }   
   ...
   $a=$this->construct_num_Page();   
    ...
    $lastPageUrl=$this->subPage_link.$this->pageNums;   
    $nextPageUrl=$this->subPage_link.($this->current_page+1);   
    $subPageCss2Str.="<td align='center'><a href='$nextPageUrl' class='pageNext1'>Next</a></td>";   
    $subPageCss2Str.="<td align='center'><a href='$lastPageUrl' class='pageEnd1'>Last</a></td>";   
    }else {   
    $subPageCss2Str.="<td align='center'><a  class='pageNext2'>Next</a></td>";   
    $subPageCss2Str.="<td align='center'><a  class='pageEnd2'>Last</a></td>";   
    }   
