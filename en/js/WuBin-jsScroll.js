...
(function ($) {
	$.fn.WBjsScroll = function (o) {
		...
		function ShowScroll_y() {
			self.append("<div class='Scroll_y' style=' position:absolute; right:0px; top:0px;'></div>");
			...
			if (set.showArrows) Scroll_y.append("<div class='Scroll_y_Up'></div>");
			Scroll_y.append("<div class='Scroll_y_Drag' style='position:relative; overflow:hidden;'><div class='Scroll_y_Drag_Bar' style=' position:relative;'></div></div>");
			
			Scroll_y_Drag = Scroll_y.find(".Scroll_y_Drag");
			Scroll_y_Drag_Bar = Scroll_y.find(".Scroll_y_Drag_Bar");

			Scroll_y_Drag_Bar.append("<div class='Scroll_y_DBT'></div>")
			.append("<div class='Scroll_y_DBM'><div class='Scroll_y_DBMB'></div></div>")
			.append("<div class='Scroll_y_DBB'></div>");

			if (set.showArrows) Scroll_y.append("<div class='Scroll_y_Down'></div>");
