    ...
    <div class="c_right">
        ...
        <div class="db_content">
            <div id="new_list">
                ...
                <?
				if(get(twoID))
				$sql="select * from lxy_download where downpwd=".($typeID-1)." and p_type_2=".get(twoID)." and language='cn' order by id desc";
				else
                ...
                ?>
                    <li>
                        <a href="upload/Download/<?php echo $row2[FileFile]; ?>" target="_blank"><? echo utfsubstr($row2[FileName],0,$strlen); ?></a>
                    </li>
                <?
                }
                ?>
