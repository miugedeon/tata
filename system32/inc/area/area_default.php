			<?php
            	$sql="select * from p_area where language='".$language."'";
				$num=$d->Execute($sql);
				if($num>0)
				{
					$pagesize=11;
					...
					$sql="select * from p_area where language='".$language."' order by p_sort desc limit ".$offset.",".$pagesize."";
...
<script language="javascript">
	...
	function GoPage()
	{
		...
		window.location.href="area_manage.php?page="+goPage+"&language=<?php echo $language?>";
	}
