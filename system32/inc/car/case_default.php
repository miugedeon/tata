<?php
	...
	if($num>0)
	{
		...
		$sql="select * from p_cy order by id desc limit ".$offset.",".$pagesize."";
...
<tr style="height:22px; line-height:22px;">
	...
	<td align="center" width="25%" class="c_333"><?php echo $row["cf"]?></td>
	<td align="center" width="25%" class="c_333"><?php echo $row["md"]?></td>
	<td align="center" width="7%" class="c_333"><?php echo $row["linkman"]?></td>
	<td align="center" class="c_333"><?php echo $row["cztel"]?></td>
	<td align="center" width="5%"><?php echo $row["carlength"]?></td>
	...
	<td align="center" width="7%"><a href="car_delete_one.php?p_id=<?php echo $row["id"]?>" onClick="return confirm('您确认删除吗？')">删除</a>|<a href="car_update.php?p_id=<?php echo $row["id"]?>&language=<?php echo $language?>&p_typelist=<?php echo $p_typelist?>">更新</a></td>
</tr>
<?php
		}
?>
