<?php
	...
	if($num>0)
	{
		...
		$sql="select * from p_join order by id desc limit ".$offset.",".$pagesize."";
...
<tr style="height:22px; line-height:22px;">
	<td align="center" width="3%">
    	<input type="checkbox" name="showid[]" id="showid" value="<?php echo $row["id"]?>">
    </td>
	<td align="center" width="3%" class="c_333"><?php echo $row["id"]?></td>
	<td align="center" width="10%" class="c_333"><?php echo $row["company"]?></td>
	<td align="center" width="10%" class="c_333"><?php echo $row["linkman"]?></td>
	<td align="center" width="7%" class="c_333"><?php echo $row["tel"]?></td>
	<td align="center" width="25%"><?php echo $row["address"]?></td>
	<td align="center" width="10%"><?php echo $row["email"]?></td>

	<td align="center" class="c_333"><?php echo $row["addtime"]?></td>
	<td align="center" class="c_333"><?php if($row["ViewFlag"]==1){?><b><font color="#CC0033">√</font><?php }?></td>
	<td align="center" width="7%"><a href="join_delete_one.php?p_id=<?php echo $row["id"]?>" onClick="return confirm('您确认删除吗？')">删除</a>|<a href="join_update.php?p_id=<?php echo $row["id"]?>&language=<?php echo $language?>&p_typelist=<?php echo $p_typelist?>">更新</a></td>
</tr>
<?php
		}
?>
