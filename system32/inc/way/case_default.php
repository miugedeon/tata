<?php
	...
	if($num>0)
	{
		...
		$sql="select * from p_way order by id desc limit ".$offset.",".$pagesize."";
...
<tr style="height:22px; line-height:22px;">
	...
	<td align="center" width="7%" class="c_333"><?php echo $row["company"]?></td>
	<td align="center" width="25%" class="c_333"><?php echo $row["way"]?></td>
	<td align="center" width="25%" class="c_333"><?php echo $row["cityy"]?></td>
	<td align="center" class="c_333"><?php echo $row["tel"]?></td>
	<td align="center" width="5%"><?php echo $row["address"]?></td>
	...
	<td align="center" width="7%"><a href="way_delete_one.php?p_id=<?php echo $row["id"]?>" onClick="return confirm('您确认删除吗？')">删除</a>|<a href="way_update.php?p_id=<?php echo $row["id"]?>&language=<?php echo $language?>&p_typelist=<?php echo $p_typelist?>">更新</a></td>
</tr>
<?php
		}
?>
